...
public class NoticeboardImages {
	...
	public static void setSideImages() {
		java.net.URL stickyPNG = NoticeBoardHomeScreen.class
				.getResource("/side_images/sticky_note.png");
		note_icon = new ImageIcon(stickyPNG);

		java.net.URL settingsPNG = NoticeBoardHomeScreen.class
				.getResource("/side_images/settings.png");
		settings_icon = new ImageIcon(settingsPNG);

		java.net.URL warningPNG = NoticeBoardHomeScreen.class
				.getResource("/side_images/warning.png");
		warning_icon = new ImageIcon(warningPNG);

		java.net.URL homePNG = NoticeBoardNotesScreen.class
				.getResource("/side_images/home.png");
		home_icon = new ImageIcon(homePNG);
	}

	public static void setHomeImages() {
		java.net.URL stickyPNG = NoticeBoardHomeScreen.class
				.getResource("/home_images/sticky_note.png");
		home_note_icon = new ImageIcon(stickyPNG);

		java.net.URL settingsPNG = NoticeBoardHomeScreen.class
				.getResource("/home_images/settings.png");
		home_settings_icon = new ImageIcon(settingsPNG);

		java.net.URL warningPNG = NoticeBoardHomeScreen.class
				.getResource("/home_images/warning.png");
