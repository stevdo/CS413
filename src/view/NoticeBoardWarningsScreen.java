...
public class NoticeBoardWarningsScreen {
	...
	public void addButtonListener(ActionListener button_listener) {
		...
		System.out.println("Warnings screen; listener added");
	}
	...
	public void init_WarningsScreen() {
		...
		int warnings_width = (int) (warnings_frame.getWidth() - (0.12 * warnings_frame
				.getWidth()));
		int options_width = (int) (warnings_frame.getWidth() - (0.88 * warnings_frame
				.getWidth()));
